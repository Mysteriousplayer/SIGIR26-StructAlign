...
class CLIPAttention(nn.Module):
    ...
    def forward(
        ...
        if inputs_size is not None:
            hidden_states, stored_attn = self.forward2(hidden_states, inputs_size, layer_id, stored_attn)
    ...
    def forward2(self, hidden_states, inputs_size, layer_id, stored_attention=None):
        """
...
class CLIPEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        if isinstance(hidden_states, tuple):
            ...
            hidden_states, stored_attn, attn_weights = self.self_attn(
    ...
    def forward(
        ...
        for idx, encoder_layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing and self.training:
                ...
                layer_outputs, stored_attn = torch.utils.checkpoint.checkpoint(
                ...
                layer_outputs, stored_attn = encoder_layer(
                    hidden_states,
                    inputs_size,
                    attention_mask,
                    causal_attention_mask,
