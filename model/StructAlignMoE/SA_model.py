...
from model.StructAlignMoE.CLIP_Fusion import CLIPModel, CLIPAttention
from model.StructAlignMoE.adapter import LoRAAdapter

class StructAlign(nn.Module):
    def __init__(self, args):
        super(StructAlign, self).__init__()
        ...
        self.etf_proj1 = nn.Linear(512, 512, bias=False)
        self.etf_proj2 = nn.Linear(512, 512, bias=False)
